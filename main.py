...
class DiseasePrediction:
    ...
    def __init__(self, model_name=None):
        ...
        # Model Save Path
        self.model_save_path = "C:/Users/chpav/OneDrive/Desktop/hacktober/saved_model"

    # Function to Load Train Dataset
    def _load_train_dataset(self):
        df_train = pd.read_csv("C:/Users/chpav/Downloads/Training.csv")
    ...
    def _load_test_dataset(self):
        df_test = pd.read_csv("C:/Users/chpav/Downloads/Testing.csv")
